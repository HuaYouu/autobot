...
const validSendChannels = ['toggle-bot', 'toggle-module', 'send-command', 'update-module-options', 'move-to-coordinates', 'stop-movement'];
const validReceiveChannels = ['log-message', 'bot-status-update', 'bot-movement-update'];
